...
${(prop)=>{
    ...
    if(prop.styleType==='pry'){
      style = 'background-color:#045696;color: whitesmoke;font-weight: 600;padding: 1rem 1rem;  '
    }else{
      style = 'color:#045696;font-weight: 600;border:1px solid  #045696;background-color:white;'
    }
    return style
  }};
