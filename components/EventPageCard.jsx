                ...
                <Grid container justifyContent='center' alignContent='center'   >
                    <Grid sx={{width: 400, margin:'0 auto' }} paddingX={3} paddingY={4}  position='absolute' top='40%' className='light-green-bg rounded-corners'>
                        ...
                        <Grid justifyContent='center' container>
                            <GreenButton text='Yes' textColor='white' bg='#045696' paddingX={4} paddingY={1} radius={5} />
                            <GreenButton text='Cancel' textColor='#045696'  paddingX={4} paddingY={1} radius={5} click={handleClose} />
                        </Grid>
                    </Grid>
