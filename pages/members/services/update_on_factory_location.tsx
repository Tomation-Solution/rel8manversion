...
const updateOnProductApi = async (data:IForm)=>{
    ...
    const resp = await axios.put('/tenant/membershipservice/update-factory-location/1/',form )
    return resp.data.data
}


const getOnProductApi = async ()=>{
    const resp = await axios.get('/tenant/membershipservice/update-factory-location/1/',)
    return resp.data.data
}
...
<div   style={{'margin':'0 auto','maxWidth':'900px'}}>
            ...
            {data?.status}
                ...
                <br /><br />
            <h1>Please find below the requirements for the Update On Factory Location:</h1>
            <ul>
                <li>
