...
export const sitename = 'rel8-man-backend-production.up.railway.app'
export const baseURL= `https:/rel8-man-backend-production.up.railway.app/tenant/${tenantName}`
